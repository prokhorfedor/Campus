...
namespace Campus.Context
{
    public class SchoolInitializer : DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
            ...
            {
            new Instructor{ID = 1,FirstMidName="Titenko",LastName="Serhii", HireDate = DateTime.Parse("2005-09-01")},
            };
            instructors.ForEach(s => context.Instructors.Add(s));
            context.SaveChanges();
            var departments = new List<Department>
            {
            new Department{DepartmentID=1,Name="FICT",StartDate=new DateTime(2021,06,16),InstructorID = 1},
            };
